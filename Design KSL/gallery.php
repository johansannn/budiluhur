...
<body>
    <ul class="nav p-2 bg-light rounded">
        ...
        <li class="nav-item">
            <a class="nav-link text-dark" href="https://www.budiluhur.ac.id/" rel="nofollow">Web Budiluhur</a>
        </li>
        <li class="nav-item">
        ...
        <div class="row">
            ...
            <div class="col-md-8 mb-2">
                <div class="card shadow">
                    <div class="card-body">
                        <div class="text-uppercase info-title mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-2">
                                <img src="https://dummyimage.com/350x250/000/fff" class="img-fluid rounded shadow"
                                    alt="gallery1" title="gallery2" />
                            </div>
                            <div class="col-md-4 mb-2">
                                <img src="https://dummyimage.com/350x250/000/fff" class="img-fluid rounded shadow"
                                    alt="gallery1" title="gallery2" />
